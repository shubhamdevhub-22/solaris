...
from app_modules.company.views import CompanyListView,CompanyCreateView,CompanyUpdateView,CompanyDeleteView, GetCompanyWarehouseAjaxView,WarehouseListView,WarehouseCreateView,WarehouseUpdateView,CompanyListAjax,WarehouseListAjax,WarehouseDeleteAjaxView
...
urlpatterns = [
    ...
    path("get-company-warehouse/",GetCompanyWarehouseAjaxView.as_view(),name="get_company_warehouse_ajax"),
