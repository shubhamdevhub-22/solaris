...
class Company(BaseModel):
    ...
    latitude = models.FloatField(_('Latitude'),max_length=100, null=True, blank=True)
    longitude = models.FloatField(_('Longitude'),max_length=100, null=True, blank=True)
    logo = models.ImageField(_("Company Logo"), upload_to='company-logo', height_field=None, width_field=None, max_length=None,null=True,blank=True)
...
class Warehouse(BaseModel):
    ...
    latitude = models.FloatField(_('Latitude'),max_length=100, null=True, blank=True)
    longitude = models.FloatField(_('Longitude'),max_length=100, null=True, blank=True)
    company = models.ForeignKey(Company,on_delete=models.CASCADE,null=True,related_name="warehouses")
    status = models.CharField(_('Status'), choices=STATUS_TYPE, max_length=20, default=IS_ACTIVE)
