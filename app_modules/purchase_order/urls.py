...
from app_modules.purchase_order.views import PurchaseOrderCreateView,GetVendorsAndProductsByCompanyAjax,AjaxGetProductDetails,AddProductInPurchaseList, PurchaseOrderListView,PurchaseOrderListAjax, PurchaseOrderUpdateView, AjaxGetUpdateProductDetails,GetProductFromBarcodeAjax
...
urlpatterns = [
    ...
    path("ajax-get-product-by-barcode/",GetProductFromBarcodeAjax.as_view(),name="ajax_get_product_by_barcode"),
